...
|------|------|----------------|---------|---------|---------|
| BTN1 | 4 | Epi（腎上腺素） | 倒數 5 分鐘 | Atropine（阿托品） | 倒數 5 分鐘 |
| BTN2 | 5 | Amio（胺碘酮） | 正數 | Adenosine（腺苷） | 正數 |
| BTN3 | 6 | D50（50% 葡萄糖） | 正數 | Naloxone（納洛酮） | 正數 |
| BTN4 | 7 | TXA（氨甲環酸） | 正數 | Nitro（硝化甘油） | 正數 |
...
| [tasks/production-roadmap.md](tasks/production-roadmap.md) | 量產化路線：各階段說明、工具、成本估算 |
