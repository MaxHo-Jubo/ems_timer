...
| 按鈕 | GPIO | Group 0（預設） | Group 1 | G0 計時模式 | G1 計時模式 |
|------|------|----------------|---------|------------|------------|
| BTN1 | 4 | Epi（腎上腺素） | Naloxone（納洛酮） | 倒數 5 分鐘 | 正數 |
| BTN2 | 5 | Amio（胺碘酮） | Nitro（硝化甘油） | 正數 | 正數 |
| BTN3 | 6 | Atropine（阿托品） | D50（50% 葡萄糖） | 倒數 5 分鐘 | 正數 |
| BTN4 | 7 | Adenosine（腺苷） | Morphine（嗎啡） | 正數 | 正數 |
